...
/**
 * Auto-suscripción push para líderes de zona (mismo flujo que TecnicoPushSetup).
 */
export default function CoordinadorPushSetup() {
  ...
  if (perm === "denied") {
    return (
      <div className="rounded-lg border border-yellow-200 bg-yellow-50 dark:bg-yellow-950/30 px-3 py-2 text-sm text-yellow-900 dark:text-yellow-100">
        Para recibir alertas de tu equipo, activa las notificaciones en Ajustes del navegador.
      </div>
    );
  }
    ...
    return (
      <div className="card p-4 border border-blue-200 bg-blue-50/50 dark:border-[#3A4565] dark:bg-[#1A2340]/80 flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div>
            <p className="font-medium text-gray-900 dark:text-white">No se pudieron activar los avisos del equipo</p>
